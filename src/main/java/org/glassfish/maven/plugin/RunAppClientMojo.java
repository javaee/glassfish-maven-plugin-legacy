...
/**
 * Runs an application client
 * 
 * @goal appclient
 * @requiresProject true
 */
public class RunAppClientMojo extends GlassFishMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            appPath = new File(appPath, application + "Client.jar");
            List<String> options = new ArrayList<String>();
            options.add("-client");
            options.add(appPath.toString());
            
            /* Generate client stubs */
            run(glassfishDirectory, GlassFishMojo.Command.APPCLIENT, options);
